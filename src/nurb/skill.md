---
name: nurb
description: Design 3D-printable parts as Python functions with nurb (build123d/OCCT). Use when the user wants a part designed, changed, or checked for 3D printing (a bracket, mount, holder, enclosure, shelf, or any STL/STEP to print), and in any directory with a parts/ folder. The user describes the part and judges it in a browser; you model it.
---
